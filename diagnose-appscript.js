 ...
 *
 * Tests:
 * 1. GET Apps Script URL
 * 2. POST ping with SCRIPT_SECRET
 * 3. POST sample update with SCRIPT_SECRET
 *
...
function validateConfig() {
  ...
  if (!CONFIG.APPS_SCRIPT_WEB_APP_URL) {
    missing.push('APPS_SCRIPT_WEB_APP_URL');
  }

  if (!CONFIG.SCRIPT_SECRET) {
    missing.push('SCRIPT_SECRET');
  }
...
function printMaskedConfig() {
  ...
  console.log(`- Contains drive.google.com: ${url.includes('drive.google.com')}`);
